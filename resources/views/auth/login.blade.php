        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="input-div one">
                ...
                <div class="div">
                    ...
                    <input id="email" type="email" class="@error('email') is-invalid @enderror input" name="email" required autocomplete="email" autofocus value="{{ old('email') }}">
